 ...
 * and performance metrics (romance, humor, rating). The
 * {@link #reactToDate(DateEvent)}
 * method allows an ergenka to update her internal state when participating in a
 * {@link DateEvent}
 */
...
public interface Ergenka {
    ...
    /**
     * Returns the ergenka's full name. The name of each ergenka is an unique
     * identifier.
     * 
     ...
     * 
     * @param dateEvent the date event the ergenka participates in, never
     *                  {@code null}
     */
